...
$SQL_INSTANCEDIR = "$Env:ProgramFiles\Microsoft SQL Server\150" #optional: Specifies a nondefault installation directory for instance-specific components like a copy of the sqlserver.exe engine. For all instances of SQL Server (both default and named), common files shared between all instances live here ending in version nnn. The usual Sql Server directory nnn values: 160,150,140,130,120,110
...
############### Server Names #################
##############################################
$DWSqlServerInstance = "scom2019ms1"
$SqlServerInstance = 'scom2019ms1'
$SqlServerReportInstance = 'scom2019ms1'
$ScomReportingMS = 'scom2019ms1'
$RMSServer = 'scom2019ms1'
...
$initialSCOMDBSize = 10240 #In MB. the default scom Opsdb size is 1GB which runs out quick.
